...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?= base_url(); ?>" class="brand-link">
    <img src="<?= base_url(); ?>/assets/dist/img/big-cow.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="<?= site_url('/orders'); ?>" class="nav-link <?= isActive('orders'); ?>">
        ...
        <li class="nav-item <?= isOpen('reportings'); ?>">
          <a href="#" class="nav-link">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="<?= site_url('reportings/ordersummary'); ?>" class="pl-5 nav-link <?= isActive('ordersummary'); ?>">
                <i class="fa fa-solid fa-list mr-2"></i>
                <p>Orders Summary</p>
              </a>
            </li>
